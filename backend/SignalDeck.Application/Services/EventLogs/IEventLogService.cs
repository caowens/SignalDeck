...
namespace SignalDeck.Application.Services.EventLogs
{
    public interface IEventLogService
    {
        ...
        Task<IEnumerable<EventLogDto>> GetByApplicationIdAsync(Guid appId);
        Task<IEnumerable<EventLogDto>> GetLogsBySeverityAsync(Guid appId, EventLogSeverity severity);
    }
}